...
pageContext.setAttribute("req1", "page value1");
...
<h1>attr map</h1>
${requestScope["my-map"] }, ${requestScope["my-map"].key1 }, ${requestScope["my-map"]["key1"] }

<h1>attr map2</h1>
${requestScope.myMap.key2 }, ${myMap.key2 }, ${myMap["key2"] }
